...
#ifdef __STDC__
  POINTER (*chunkfun)(int); /* User's fcn to allocate a chunk.  */
  void (*freefun) (POINTER);		/* User's function to free a chunk.  */
#else
  POINTER (*chunkfun)(); /* User's fcn to allocate a chunk.  */
